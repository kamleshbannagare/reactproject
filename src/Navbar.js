...
import web from "../src/img/skbimg1.png";
...
const Navbar = () =>{
  ...
  <NavLink className="navbar-brand" to="#"><img src={web} width="50" height="50" class="d-inline-block align-center" alt="image" />SoftTechKB</NavLink>
